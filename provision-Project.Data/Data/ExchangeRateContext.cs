...
namespace provision_Project.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        {
            optionsBuilder.UseMySql("Server=localhost;Port=3306;Database=tcmb_exchange_rates;User=root;Password=AyranGelistirme2002!",
